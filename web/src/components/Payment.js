...
const Payment = () => {
  return (
    <div class="flex flex-col w-full bg-[#524BA7] text-white rounded-lg items-center ">
        <h1 class="text-5xl font-semibold pb-5 py-24">Healthcare payments made easy.</h1>
        <p class="text-2xl pb-12">A secure way to manage, track, and pay–so you can focus on the good stuff.</p>
